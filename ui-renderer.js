...
function getWeatherIcon(iconCode) {
    const icons = {
        "01d": "fa-solid fa-sun text-warning",
        "01n": "fa-solid fa-moon text-info",

        "02d": "fa-solid fa-cloud-sun text-secondary",
        "02n": "fa-solid fa-cloud-moon text-secondary",

        "03d": "fa-solid fa-cloud text-secondary",
        "03n": "fa-solid fa-cloud text-secondary",

        "04d": "fa-solid fa-cloud text-secondary",
        "04n": "fa-solid fa-cloud text-secondary",

        "09d": "fa-solid fa-cloud-showers-heavy text-primary",
        "09n": "fa-solid fa-cloud-showers-heavy text-primary",

        "10d": "fa-solid fa-cloud-rain text-primary",
        "10n": "fa-solid fa-cloud-rain text-primary",

        "11d": "fa-solid fa-bolt text-warning",
        "11n": "fa-solid fa-bolt text-warning",

        "13d": "fa-solid fa-snowflake text-info",
        "13n": "fa-solid fa-snowflake text-info",

        "50d": "fa-solid fa-smog text-muted",
        "50n": "fa-solid fa-smog text-muted",
    };

    return icons[iconCode] || "fa-solid fa-circle-question text-muted";
}
